...
socorif_block_comment_start('about');

// Felder abrufen
$intro_label = socorif_get_field('intro_label');
$title = socorif_get_field('title');
$intro_text = socorif_get_field('intro_text');
$mission_title = socorif_get_field('mission_title');
$mission_text_1 = socorif_get_field('mission_text_1');
$mission_text_2 = socorif_get_field('mission_text_2');
$image_1 = socorif_get_field('image_1');
$image_2 = socorif_get_field('image_2');
$image_3 = socorif_get_field('image_3');
$image_4 = socorif_get_field('image_4');
$stats_title = socorif_get_field('stats_title');
...
?>
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="max-w-4xl">
            <?php if ($intro_label) : ?>
                <p class="text-base/7 font-semibold text-yellow-500 dark:text-yellow-400">
                    <?php echo esc_html($intro_label); ?>
                </p>
            <?php endif; ?>

            <?php if ($title) : ?>
                <h1 class="section-title mt-2 tracking-tight text-pretty">
                    <?php echo esc_html($title); ?>
                </h1>
            <?php endif; ?>

            <?php if ($intro_text) : ?>
                <p class="section-description mt-6 text-balance">
                ...
                <div class="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 xl:gap-8">
                    <?php if ($image_1) : ?>
                        <div class="aspect-square overflow-hidden rounded-xl shadow-xl outline-1 -outline-offset-1 outline-black/10 dark:shadow-none dark:outline-white/10">
                            <?php echo socorif_image($image_1, 'medium_large', [
                                'class' => 'block size-full object-cover cursor-pointer',
                                'loading' => 'lazy'
                            ]); ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($image_2) : ?>
                        <div class="-mt-8 aspect-square overflow-hidden rounded-xl shadow-xl outline-1 -outline-offset-1 outline-black/10 lg:-mt-40 dark:shadow-none dark:outline-white/10">
                            <?php echo socorif_image($image_2, 'medium_large', [
                                'class' => 'block size-full object-cover cursor-pointer',
                                'loading' => 'lazy'
                            ]); ?>
                        </div>
                    ...
                    <?php if ($image_3) : ?>
                        <div class="aspect-square overflow-hidden rounded-xl shadow-xl outline-1 -outline-offset-1 outline-black/10 dark:shadow-none dark:outline-white/10">
                            <?php echo socorif_image($image_3, 'medium_large', [
                                'class' => 'block size-full object-cover cursor-pointer',
                                'loading' => 'lazy'
                            ]); ?>
                        </div>
                    ...
                    <?php if ($image_4) : ?>
                        <div class="-mt-8 aspect-square overflow-hidden rounded-xl shadow-xl outline-1 -outline-offset-1 outline-black/10 lg:-mt-40 dark:shadow-none dark:outline-white/10">
                            <?php echo socorif_image($image_4, 'medium_large', [
                                'class' => 'block size-full object-cover cursor-pointer',
                                'loading' => 'lazy'
                            ]); ?>
                        </div>
...
socorif_block_comment_end('about');
