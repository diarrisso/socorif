...
(function () {
  ...
  class BlogGridBlock {
    ...
    async filterPosts() {
      ...
      try {
        ...
        this.showError(
          "Fehler beim Filtern der Beiträge. Bitte versuchen Sie es erneut.",
        );
      } finally {
    ...
    async loadMore() {
      ...
      try {
        ...
        this.showError(
          "Fehler beim Laden weiterer Beiträge. Bitte versuchen Sie es erneut.",
        );
      } finally {
        this.alpineData.loading = false;
      }
    ...
    async changePage(page) {
      ...
      try {
        ...
        this.showError(
          "Fehler beim Laden der Seite. Bitte versuchen Sie es erneut.",
        );
      } finally {
        this.alpineData.loading = false;
      }
    ...
    showError(message) {
      ...
      notification.className =
        "blog-grid-error fixed top-4 right-4 bg-red-500 text-white px-6 py-4 rounded-lg shadow-lg z-50 max-w-md";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const blogGridBlocks = document.querySelectorAll(
      ".blog-grid-block[x-data]",
    );
